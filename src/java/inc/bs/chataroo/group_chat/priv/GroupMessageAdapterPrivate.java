...
public class GroupMessageAdapterPrivate extends RecyclerView.Adapter<GroupMessageAdapterPrivate.MessageViewHolder>{
    ...
    public GroupMessageAdapterPrivate(List<GroupMessagesPublic> mMessageList , Context context, String currentuser) {
