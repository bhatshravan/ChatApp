...
public class GroupChatPublic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(uthumb!=null)
            Picasso.with(GroupChatPublic.this).load(uthumb).error(R.drawable.default_avatar).placeholder(R.drawable.default_avatar).into(mProfileImage);
        ...
        mAdapter = new GroupMessageAdapter(messagesList,GroupChatPublic.this,mCurrentUserId);
                ...
                chatRef.child(Constants.CHAT_GROUP_MEMBERS).child(mCurrentUserId).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        else
                        {
                            ...
                            {
                                Toast.makeText(GroupChatPublic.this,R.string.group_pub_banned,Toast.LENGTH_SHORT).show();
                                finish();
                            }
                            else if(friend.equals("temp"))
                            {
                                ...
                                {
                                    Toast.makeText(GroupChatPublic.this,"You have been banned for 24 hours",Toast.LENGTH_SHORT).show();
                                    blocked=true;
                                    finish();
                                }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        {
            Intent i = new Intent(GroupChatPublic.this, ChatActivity.class);
